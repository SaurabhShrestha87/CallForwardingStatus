...
public class SmsReceiver extends BroadcastReceiver {
    ...
    private static final String BASE_URL = "http://192.168.29.159:8080/message/receive";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        SharedPreferences pref = context.getSharedPreferences("receiver", Context.MODE_PRIVATE);
        String receiver = pref.getString("PHONE_NUMBER", "");
        String messageContent = ForwardingConfig.getDefaultJsonTemplate()
                .replaceAll("%from%", sender)
                .replaceAll("%to%", receiver)
        ...
        this.callWebHook(
                messageContent,
                ForwardingConfig.getDefaultJsonHeaders()
        );
    }

    protected void callWebHook(String message, String headers) {
        ...
        Data data = new Data.Builder()
                .putString(WebHookWorkRequest.DATA_URL, SmsReceiver.BASE_URL)
    ...
    private String detectSim(Bundle bundle) {
        ...
        for (String key : keySet) {
            Log.w("TEST@@", "detectSim: " + bundle.get(key));
            switch (key) {
                case "phone":
